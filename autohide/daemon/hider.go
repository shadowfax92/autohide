...
// GetFrontmostApp returns the active application process name used to reset that app's timer.
...
// GetVisibleApps returns app process names that are currently visible and eligible for autohide.
...
// HideApp hides the whole application process using macOS' native app-level hide behavior.
